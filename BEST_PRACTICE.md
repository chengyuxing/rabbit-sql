...
Implement interface: `com.github.chengyuxing.sql.support.QueryCacheManager` to create cache layer and invoke `BakiDao#setQueryCacheManager`  to enable the cache support.
